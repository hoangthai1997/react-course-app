...
function Navbar() {
  ...
  return (
    <header style={{padding: "1rem 1.5rem", marginBottom: "1rem", borderBottom: "1px solid #e5e7eb", display: "flex", justifyContent: "space-between"}}>
...
function HomePage() {
  ...
  return (
    <div style={{padding: "0 1.5rem"}}>
      <h1>Home</h1>
      {user.isAuth ? (<p>Welcome back, {user.name}!</p>) : (<p>You are not logged in. Go to the login page to sign in.</p>) }
